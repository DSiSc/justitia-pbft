...
help:
	@echo 'Management commands for DSiSc/justitia-pbft:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building justitia-pbft ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/justitia-pbft/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/justitia-pbft/version.BuildDate=${BUILD_DATE}" ./...
